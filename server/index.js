...
const certPath = '/etc/letsencrypt/live/server.vrealism.com';
...
app.post("/create", (req, res) => {
  ...
  const architect = "";
  const sql =
    "INSERT INTO project (proj_id,proj_address,home_owner_name,home_owner_phone,home_owner_email,proj_houseOwnerName,proj_description,proj_status,proj_code,proj_filesNomenclature,proj_dateCreated,proj_dateAssigned,proj_dateDelivered,client_cli_id,squarefeet,surveyor,	architec) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
  db.query(
    sql,
    [
      "",
...
app.post("/delete/home/project", (req, res) => {
    const idproj = req.body.deleteid;
